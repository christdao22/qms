...
<div class="panel panel-primary">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-sm-12">
                <h3>{{ trans('app.display_2') }} <button class="pull-right btn btn-sm btn-primary"
    ...
    <div class="panel-body" id="fullscreen" style="color:{{ (!empty($setting->color)?$setting->color:'#ffffff') }}">
        ...
        <div class="media" style="height:60px;background:#ffcd03;margin-top:-20px;margin-bottom:10px">
        ...
        var display = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //notification sound
                    if (data.status) {
                        // speechSynthesis.speak(new SpeechSynthesisUtterance('Deped'));
                        // var url  = "{{ URL::to('') }}";
