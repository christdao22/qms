...
<div class="panel panel-primary">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-sm-12">
                <h3>{{ trans('app.display_1') }} <button class="pull-right btn btn-sm btn-primary"
    ...
    <div class="panel-body" id="fullscreen" style="color:{{ (!empty($setting->color)?$setting->color:'#ffffff') }}">
        <div class="media" style="height:60px;background:#3498db;margin-top:-20px;margin-bottom:10px">
            <div class="media-left hidden-xs">
                <img class="media-object" style="height:59px;" src="{{ asset('public/assets/img/icons/logo1.png') }}"
                    alt="Logo">
            </div>
