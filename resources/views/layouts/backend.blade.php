...
<html lang="en">
    ...
    <body class="cm-no-transition cm-1-navbar loader-process">
        ...
        <div id="cm-menu">
            <nav class="cm-navbar cm-navbar-primary">
                <div class="cm-flex"><a href="javascript:void(0)" class="cm-logo">
                    <img src="{{ asset('public/assets/img/icons/logo.jpg') }}" width="180" height="50" style="width: 100% !important ;">
                </a></div>
                    ...
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            ...
                            <li class="cm-submenu {{ (Request::segment(2)=='token' ? 'open' : '') }}">
                                <a class="sf-user-id">Priority Number <span class="caret"></span></a>
                                <ul>
                                    <li class="{{ (Request::is('admin/token/list') ? 'active' : '') }}">
                                        <a href="{{ url('admin/token/auto') }}">Auto Priority Number</a>
                                    </li>
                                    <li class="{{ (Request::is('admin/token/create') ? 'active' : '') }}">
                                        <a href="{{ url('admin/token/create') }}">Manual / VIP </a>
                                    </li>
                                    <li class="{{ (Request::is('admin/token/current') ? 'active' : '') }}">
                                        <a href="{{ url('admin/token/current') }}">Active / Current Prio <i class="fa fa-dot-circle-o" style="color:#03d003"></i></a>
                                    </li>
                                    <li class="{{ (Request::is('admin/token/report') ? 'active' : '') }}">
                                        <a href="{{ url('admin/token/report') }}">Priority Report</a>
                                    </li>
                                    ...
                                    <li class="bg-danger {{ (Request::is('admin/token/setting') ? 'active' : '') }}">
                                        <a href="{{ url('admin/token/setting') }}">Auto Priority Setting</a>
                                    </li>
                                </ul>
                            </li>
                            @endif
        ...
        <header id="cm-header">
            <nav class="cm-navbar cm-navbar-primary">
                <div class="btn btn-primary md-menu-white1 hidden-md hidden-lg" data-toggle="cm-menu"></div>
                <div class="cm-flex">
        ...
        <!-- certificates script -->
        <script src="{{ asset('public/assets/js/certificates.js') }}"></script>
