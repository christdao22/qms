...
class SettingController extends Controller
{
    ...
    public function create(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'deped_seal'  => 'image|mimes:jpeg,png,jpg,gif|max:3072',
            'email'       => 'max:255',
            'phone'       => 'max:255',
            'address'     => 'max:255',
            'city'        => 'max:255',
            'office'      => 'max:255',
            'sds_fullname'      => 'max:100',
        ...
        ->setAttributeNames(array(
           ...
           'deped_seal' => trans('app.deped_seal'),
           'email' => trans('app.email'),
           'phone' => trans('app.mobile'),
           'address' => trans('app.address'),
           'city' => trans('app.city'),
           'office' => trans('app.office'),
           'sds_fullname' => trans('app.sds_fullname'),
        ...
        else
        {
            //
            //Deped Seal
            // if (!empty($request->deped_seal)) {
            //     $deped_sealPath = 'assets/img/logo/Seal_of_the_Deped.png';
            //     $deped_seal = $request->deped_seal;
            //     Image::make($deped_seal)->save($deped_sealPath);
            // } else if (!empty($request->deped_seal)) {
            //     $deped_sealPath = $request->deped_seal;
            // }
            ...
            if (!empty($request->id)) {
                ...
                $update = Setting::where('id',$request->id)
                    ->update([
                        ...
                        'sds_fullname'      => $request->sds_fullname,
